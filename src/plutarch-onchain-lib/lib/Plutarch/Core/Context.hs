...
paddressCredential, ptxOutAddress, ptxOutCredential, ptxOutValue, ptxInInfoResolved, ptxInInfoOutRef, pscriptContextTxInfo, ptxInfoSignatories, ptxOutInlineDatumData, ptxOutDatum) where
...
ptxOutInlineDatumData :: Term s PTxOut -> Term s PData
ptxOutInlineDatumData =
  flip pmatch $ \txo ->
